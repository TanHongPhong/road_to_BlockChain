import { __toESM } from "./chunk-Ye9CTm_R.js";
import { require_react } from "./react-BqPUdaMv.js";
import { require_react_dom } from "./react-dom-0i1ELsNk.js";
import { require_jsx_runtime } from "./jsx-runtime-DxMFw2vr.js";

//#region node_modules/@react-google-maps/api/dist/esm.js
...
function requireInvariant() {
	...
	*/
	...
	invariant_1 = function invariant$1(condition, format, a, b, c, d, e, f) {
...
function applyUpdaterToNextProps(updaterMap$10, prevProps, nextProps, instance) {
	var map = {};
	var iter = (fn, key) => {
	...
	forEach(updaterMap$10, iter);
	return map;
}
function registerEvents(props, instance, eventMap$10) {
	return reduce(eventMap$10, function reducer(acc, googleEventName, onEventName) {
...
function unregisterEvents() {
	(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : []).forEach(unregisterEvent);
}
function applyUpdatersToPropsAndRegisterEvents(_ref) {
	var { updaterMap: updaterMap$10, eventMap: eventMap$10, prevProps, nextProps, instance } = _ref;
	var registeredEvents = registerEvents(nextProps, instance, eventMap$10);
	applyUpdaterToNextProps(updaterMap$10, prevProps, nextProps, instance);
...
function GoogleMapFunctional(_ref) {
	var { children, options, id, mapContainerStyle, mapContainerClassName, center, onClick, onDblClick, onDrag, onDragEnd, onDragStart, onMouseMove, onMouseOut, onMouseOver, onMouseDown, onMouseUp, onRightClick, onCenterChanged, onLoad, onUnmount } = _ref;
	...
	(0, import_react.useEffect)(() => {
		if (options && map !== null) map.setOptions(options);
	}, [map, options]);
	(0, import_react.useEffect)(() => {
		if (map !== null && typeof center !== "undefined") map.setCenter(center);
	}, [map, center]);
	(0, import_react.useEffect)(() => {
		if (map && onDblClick) {
	...
	(0, import_react.useEffect)(() => {
		var map$1 = ref.current === null ? null : new google.maps.Map(ref.current, options);
		setMap(map$1);
		if (map$1 !== null && onLoad) onLoad(map$1);
		return () => {
			if (map$1 !== null) {
				if (onUnmount) onUnmount(map$1);
			}
		};
	}, []);
	...
	constructor() {
		...
		_defineProperty(this, "setMapCallback", () => {
			if (this.state.map !== null) {
				if (this.props.onLoad) this.props.onLoad(this.state.map);
			}
		});
...
function injectScript(_ref) {
	...
	if (!isBrowser) return Promise.reject(/* @__PURE__ */ new Error("document is undefined"));
	return new Promise(function injectScriptCallback(resolve, reject) {
		var existingScript = document.getElementById(id);
		var windowWithGoogleMap = window;
		if (existingScript) {
			var dataStateAttribute = existingScript.getAttribute("data-state");
			if (existingScript.src === url && dataStateAttribute !== "error") if (dataStateAttribute === "ready") return resolve(id);
			else {
...
function preventGoogleFonts() {
	...
	if (head) {
		...
		head.insertBefore = function insertBefore(newElement, referenceElement) {
			if (!isGoogleFontStyle(newElement)) Reflect.apply(trueInsertBefore, head, [newElement, referenceElement]);
			return newElement;
		};
		var trueAppend = head.appendChild.bind(head);
		head.appendChild = function appendChild(textNode) {
			if (!isGoogleFontStyle(textNode)) Reflect.apply(trueAppend, head, [textNode]);
			return textNode;
		};
	}
}
...
var LoadScript = class extends import_react.PureComponent {
	constructor() {
		...
		_defineProperty(this, "state", { loaded: false });
		...
		_defineProperty(this, "isCleaningUp", /* @__PURE__ */ _asyncToGenerator(function* () {
			function promiseCallback(resolve) {
				if (!cleaningUp) resolve();
				else if (isBrowser) var timer = window.setInterval(function interval() {
					if (!cleaningUp) {
		...
		_defineProperty(this, "cleanup", () => {
			...
			Array.prototype.slice.call(document.getElementsByTagName("script")).filter(function filter(script$1) {
				return typeof script$1.src === "string" && script$1.src.includes("maps.googleapis");
			}).forEach(function forEach$1(script$1) {
				if (script$1.parentNode) script$1.parentNode.removeChild(script$1);
			});
			Array.prototype.slice.call(document.getElementsByTagName("link")).filter(function filter(link) {
				return link.href === "https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Google+Sans";
			}).forEach(function forEach$1(link) {
				if (link.parentNode) link.parentNode.removeChild(link);
			});
			Array.prototype.slice.call(document.getElementsByTagName("style")).filter(function filter(style) {
				return style.innerText !== void 0 && style.innerText.length > 0 && style.innerText.includes(".gm-");
			}).forEach(function forEach$1(style) {
				if (style.parentNode) style.parentNode.removeChild(style);
			});
		});
		_defineProperty(this, "injectScript", () => {
			if (this.props.preventGoogleFontsLoading) preventGoogleFonts();
	...
	render() {
		return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("div", { ref: this.getRef }), this.state.loaded ? this.props.children : this.props.loadingElement || (0, import_jsx_runtime.jsx)(DefaultLoadingElement, {})] });
	}
};
...
function useLoadScript(_ref) {
	...
	(0, import_react.useEffect)(function applyPreventGoogleFonts() {
		if (isBrowser && preventGoogleFontsLoading) preventGoogleFonts();
	}, [preventGoogleFontsLoading]);
	(0, import_react.useEffect)(function validateLoadedState() {
		if (isLoaded) invariant(!!window.google, "useLoadScript was marked as loaded, but window.google is not present. Something went wrong.");
	}, [isLoaded]);
...
var isEqual = /* @__PURE__ */ getDefaultExportFromCjs(function equal$1(a, b) {
	if (a === b) return true;
	if (a && b && typeof a == "object" && typeof b == "object") {
		...
		if (Array.isArray(a)) {
			...
			for (i = length; i-- !== 0;) if (!equal$1(a[i], b[i])) return false;
			return true;
		}
...
*/
var LoaderStatus;
(function(LoaderStatus$1) {
	LoaderStatus$1[LoaderStatus$1["INITIALIZED"] = 0] = "INITIALIZED";
	LoaderStatus$1[LoaderStatus$1["LOADING"] = 1] = "LOADING";
	LoaderStatus$1[LoaderStatus$1["SUCCESS"] = 2] = "SUCCESS";
	LoaderStatus$1[LoaderStatus$1["FAILURE"] = 3] = "FAILURE";
...
var Loader = class Loader {
	...
	*/
	constructor(_ref) {
		...
		if (Loader.instance) {
			if (!isEqual(this.options, Loader.instance.options)) throw new Error("Loader must not be called again with different options. ".concat(JSON.stringify(this.options), " !== ").concat(JSON.stringify(Loader.instance.options)));
	...
	*/
	createUrl() {
		...
		if (this.apiKey) url += "&key=".concat(this.apiKey);
	...
	*/
	setScript() {
		...
		if (!((_b = (_a = window === null || window === void 0 ? void 0 : window.google) === null || _a === void 0 ? void 0 : _a.maps) === null || _b === void 0 ? void 0 : _b.importLibrary)) ((g) => {
			...
			b = b[c] || (b[c] = {});
			var d = b.maps || (b.maps = {}), r = /* @__PURE__ */ new Set(), e = new URLSearchParams(), u = () => h || (h = new Promise((f, n) => __awaiter(this, void 0, void 0, function* () {
				var _a$1;
				...
				a.nonce = this.nonce || ((_a$1 = m.querySelector("script[nonce]")) === null || _a$1 === void 0 ? void 0 : _a$1.nonce) || "";
				m.head.append(a);
			})));
...
function useJsApiLoader(_ref) {
	var { id = defaultLoadScriptProps.id, version = defaultLoadScriptProps.version, nonce, googleMapsApiKey, language, region, libraries = defaultLibraries, preventGoogleFontsLoading, mapIds, authReferrerPolicy } = _ref;
	var isMounted = (0, import_react.useRef)(false);
	var [isLoaded, setLoaded] = (0, import_react.useState)(false);
	var [loadError, setLoadError] = (0, import_react.useState)(void 0);
	(0, import_react.useEffect)(function trackMountedState() {
...
function _objectSpread$f(e) {
	for (var r = 1; r < arguments.length; r++) {
		...
		r % 2 ? ownKeys$f(Object(t), !0).forEach(function(r$1) {
			_defineProperty(e, r$1, t[r$1]);
		}) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$f(Object(t)).forEach(function(r$1) {
...
var eventMap$h = {};
var updaterMap$h = { options(instance, options) {
...
function TrafficLayerFunctional(_ref) {
	...
	(0, import_react.useEffect)(() => {
		var trafficLayer = new google.maps.TrafficLayer(_objectSpread$f(_objectSpread$f({}, options), {}, { map }));
...
var TrafficLayer = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "state", { trafficLayer: null });
		_defineProperty(this, "setTrafficLayerCallback", () => {
			if (this.state.trafficLayer !== null && this.props.onLoad) this.props.onLoad(this.state.trafficLayer);
		});
		_defineProperty(this, "registeredEvents", []);
	}
	componentDidMount() {
		var trafficLayer = new google.maps.TrafficLayer(_objectSpread$f(_objectSpread$f({}, this.props.options), {}, { map: this.context }));
		this.registeredEvents = applyUpdatersToPropsAndRegisterEvents({
...
var BicyclingLayer = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "state", { bicyclingLayer: null });
		_defineProperty(this, "setBicyclingLayerCallback", () => {
			if (this.state.bicyclingLayer !== null) {
				this.state.bicyclingLayer.setMap(this.context);
				if (this.props.onLoad) this.props.onLoad(this.state.bicyclingLayer);
			}
		});
	}
	componentDidMount() {
...
var TransitLayer = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "state", { transitLayer: null });
		_defineProperty(this, "setTransitLayerCallback", () => {
			if (this.state.transitLayer !== null) {
				this.state.transitLayer.setMap(this.context);
				if (this.props.onLoad) this.props.onLoad(this.state.transitLayer);
			}
		});
	}
	componentDidMount() {
...
function _objectSpread$e(e) {
	for (var r = 1; r < arguments.length; r++) {
		var t = null != arguments[r] ? arguments[r] : {};
		r % 2 ? ownKeys$e(Object(t), !0).forEach(function(r$1) {
			_defineProperty(e, r$1, t[r$1]);
		}) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$e(Object(t)).forEach(function(r$1) {
			Object.defineProperty(e, r$1, Object.getOwnPropertyDescriptor(t, r$1));
		});
	}
	return e;
...
function DrawingManagerFunctional(_ref) {
	...
	(0, import_react.useEffect)(() => {
		if (instance !== null) instance.setDrawingMode(drawingMode !== null && drawingMode !== void 0 ? drawingMode : null);
	...
	(0, import_react.useEffect)(() => {
		...
		var drawingManager = new google.maps.drawing.DrawingManager(_objectSpread$e(_objectSpread$e({}, options), {}, { map }));
...
var DrawingManager = class extends import_react.PureComponent {
	constructor(props) {
		super(props);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { drawingManager: null });
		_defineProperty(this, "setDrawingManagerCallback", () => {
			if (this.state.drawingManager !== null && this.props.onLoad) this.props.onLoad(this.state.drawingManager);
		});
		invariant(!!google.maps.drawing, "Did you include prop libraries={['drawing']} in the URL? %s", google.maps.drawing);
	}
	componentDidMount() {
		var drawingManager = new google.maps.drawing.DrawingManager(_objectSpread$e(_objectSpread$e({}, this.props.options), {}, { map: this.context }));
		this.registeredEvents = applyUpdatersToPropsAndRegisterEvents({
...
function _objectSpread$d(e) {
	for (var r = 1; r < arguments.length; r++) {
		var t = null != arguments[r] ? arguments[r] : {};
		r % 2 ? ownKeys$d(Object(t), !0).forEach(function(r$1) {
			_defineProperty(e, r$1, t[r$1]);
		}) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$d(Object(t)).forEach(function(r$1) {
			Object.defineProperty(e, r$1, Object.getOwnPropertyDescriptor(t, r$1));
		});
	}
	return e;
...
function MarkerFunctional(_ref) {
	...
	(0, import_react.useEffect)(() => {
		if (instance && clickable !== void 0) instance.setClickable(clickable);
	}, [instance, clickable]);
	(0, import_react.useEffect)(() => {
		if (instance && cursor !== void 0) instance.setCursor(cursor);
	}, [instance, cursor]);
	(0, import_react.useEffect)(() => {
		if (instance && icon !== void 0) instance.setIcon(icon);
	}, [instance, icon]);
	(0, import_react.useEffect)(() => {
		if (instance && label !== void 0) instance.setLabel(label);
	}, [instance, label]);
	(0, import_react.useEffect)(() => {
		if (instance && opacity !== void 0) instance.setOpacity(opacity);
	}, [instance, opacity]);
	(0, import_react.useEffect)(() => {
		if (instance && shape !== void 0) instance.setShape(shape);
	}, [instance, shape]);
	(0, import_react.useEffect)(() => {
		if (instance && title !== void 0) instance.setTitle(title);
	}, [instance, title]);
	(0, import_react.useEffect)(() => {
		if (instance && zIndex !== void 0) instance.setZIndex(zIndex);
	}, [instance, zIndex]);
	(0, import_react.useEffect)(() => {
	...
	(0, import_react.useEffect)(() => {
		var markerOptions = _objectSpread$d(_objectSpread$d(_objectSpread$d({}, options || defaultOptions$5), clusterer ? defaultOptions$5 : { map }), {}, { position });
	...
	var chx = (0, import_react.useMemo)(() => {
		return children ? import_react.Children.map(children, (child) => {
			...
			return (0, import_react.cloneElement)(child, { anchor: instance });
		}) : null;
	}, [children, instance]);
...
var Marker = class extends import_react.PureComponent {
	...
	componentDidMount() {
		...
		return _asyncToGenerator(function* () {
			var markerOptions = _objectSpread$d(_objectSpread$d(_objectSpread$d({}, _this.props.options || defaultOptions$5), _this.props.clusterer ? defaultOptions$5 : { map: _this.context }), {}, { position: _this.props.position });
			_this.marker = new google.maps.Marker(markerOptions);
			if (_this.props.clusterer) _this.props.clusterer.addMarker(_this.marker, !!_this.props.noClustererRedraw);
			else _this.marker.setMap(_this.context);
			...
			if (_this.props.onLoad) _this.props.onLoad(_this.marker);
		})();
	}
	componentDidUpdate(prevProps) {
		if (this.marker) {
	...
	componentWillUnmount() {
		...
		else if (this.marker) this.marker.setMap(null);
	}
	render() {
		return (this.props.children ? import_react.Children.map(this.props.children, (child) => {
			if (!(0, import_react.isValidElement)(child)) return child;
			return (0, import_react.cloneElement)(child, { anchor: this.marker });
		}) : null) || null;
	}
};
_defineProperty(Marker, "contextType", MapContext);
var ClusterIcon = function() {
	function ClusterIcon$1(cluster, styles) {
		cluster.getClusterer().extend(ClusterIcon$1, google.maps.OverlayView);
	...
	ClusterIcon$1.prototype.onBoundsChanged = function() {
		this.cDraggingMapByCluster = this.cMouseDownInCluster;
	};
	ClusterIcon$1.prototype.onMouseDown = function() {
		this.cMouseDownInCluster = true;
		this.cDraggingMapByCluster = false;
	};
	ClusterIcon$1.prototype.onClick = function(event) {
		...
		if (!this.cDraggingMapByCluster) {
			...
			*/
			...
			if (markerClusterer_1.getZoomOnClick()) {
				...
				if (map !== null && "fitBounds" in map) map.fitBounds(bounds_1);
				this.timeOut = window.setTimeout(function() {
					var map$1 = markerClusterer_1.getMap();
					if (map$1 !== null) {
						if ("fitBounds" in map$1) map$1.fitBounds(bounds_1);
						var zoom = map$1.getZoom() || 0;
						if (maxZoom_1 !== null && zoom > maxZoom_1) map$1.setZoom(maxZoom_1 + 1);
					}
				}, 100);
			}
	...
	ClusterIcon$1.prototype.onMouseOver = function() {
		/**
	...
	ClusterIcon$1.prototype.onMouseOut = function() {
		/**
	...
	ClusterIcon$1.prototype.onAdd = function() {
		var _a;
	...
	ClusterIcon$1.prototype.onRemove = function() {
	...
	ClusterIcon$1.prototype.draw = function() {
	...
	ClusterIcon$1.prototype.hide = function() {
		if (this.div) this.div.style.display = "none";
		this.visible = false;
	};
	ClusterIcon$1.prototype.show = function() {
	...
	ClusterIcon$1.prototype.useStyle = function(sums) {
		this.sums = sums;
	...
	ClusterIcon$1.prototype.setCenter = function(center) {
		this.center = center;
	};
	ClusterIcon$1.prototype.getPosFromLatLng = function(latlng) {
	...
	return ClusterIcon$1;
}();
var Cluster$1 = function() {
	function Cluster$2(markerClusterer) {
	...
	Cluster$2.prototype.getSize = function() {
		return this.markers.length;
	};
	Cluster$2.prototype.getMarkers = function() {
		return this.markers;
	};
	Cluster$2.prototype.getCenter = function() {
		return this.center;
	};
	Cluster$2.prototype.getMap = function() {
		return this.map;
	};
	Cluster$2.prototype.getClusterer = function() {
		return this.markerClusterer;
	};
	Cluster$2.prototype.getBounds = function() {
		var bounds = new google.maps.LatLngBounds(this.center, this.center);
		var markers = this.getMarkers();
		for (var _i = 0, markers_1 = markers; _i < markers_1.length; _i++) {
			var position = markers_1[_i].getPosition();
			if (position) bounds.extend(position);
		}
		return bounds;
	};
	Cluster$2.prototype.remove = function() {
		this.clusterIcon.setMap(null);
		this.markers = [];
		delete this.markers;
	};
	Cluster$2.prototype.addMarker = function(marker) {
		var _a;
		...
		if (maxZoom !== null && typeof zoom !== "undefined" && zoom > maxZoom) {
			...
			if (marker.getMap() !== this.map) marker.setMap(this.map);
		} else if (mCount === this.minClusterSize) for (var _i = 0, _b = this.markers; _i < _b.length; _i++) _b[_i].setMap(null);
		else marker.setMap(null);
		return true;
	};
	Cluster$2.prototype.isMarkerInClusterBounds = function(marker) {
		if (this.bounds !== null) {
			var position = marker.getPosition();
	...
	Cluster$2.prototype.calculateBounds = function() {
		this.bounds = this.markerClusterer.getExtendedBounds(new google.maps.LatLngBounds(this.center, this.center));
	};
	Cluster$2.prototype.updateIcon = function() {
		var _a;
		var mCount = this.markers.length;
		var maxZoom = this.markerClusterer.getMaxZoom();
		var zoom = (_a = this.map) === null || _a === void 0 ? void 0 : _a.getZoom();
	...
	Cluster$2.prototype.isMarkerAlreadyAdded = function(marker) {
...
var Clusterer = function() {
	function Clusterer$1(map, optMarkers, optOptions) {
		...
		this.extend(Clusterer$1, google.maps.OverlayView);
		this.markers = [];
		this.clusters = [];
		this.listeners = [];
		this.activeMap = null;
		...
		if (optOptions.zoomOnClick !== void 0) this.zoomOnClick = optOptions.zoomOnClick;
		this.averageCenter = false;
		if (optOptions.averageCenter !== void 0) this.averageCenter = optOptions.averageCenter;
		this.ignoreHidden = false;
		if (optOptions.ignoreHidden !== void 0) this.ignoreHidden = optOptions.ignoreHidden;
		this.enableRetinaIcons = false;
		if (optOptions.enableRetinaIcons !== void 0) this.enableRetinaIcons = optOptions.enableRetinaIcons;
		...
		if (navigator.userAgent.toLowerCase().indexOf("msie") !== -1) this.batchSize = this.batchSizeIE;
		this.timerRefStatic = null;
		this.setupStyles();
		this.addMarkers(optMarkers, true);
		this.setMap(map);
	}
	Clusterer$1.prototype.onZoomChanged = function() {
		var _a, _b;
	...
	Clusterer$1.prototype.onIdle = function() {
		this.redraw();
	};
	Clusterer$1.prototype.onAdd = function() {
		var map = this.getMap();
		this.activeMap = map;
		this.ready = true;
		this.repaint();
		if (map !== null) this.listeners = [google.maps.event.addListener(map, "zoom_changed", this.onZoomChanged), google.maps.event.addListener(map, "idle", this.onIdle)];
	};
	Clusterer$1.prototype.onRemove = function() {
		for (var _i = 0, _a = this.markers; _i < _a.length; _i++) {
			var marker = _a[_i];
			if (marker.getMap() !== this.activeMap) marker.setMap(this.activeMap);
		}
		for (var _b = 0, _c = this.clusters; _b < _c.length; _b++) _c[_b].remove();
		this.clusters = [];
	...
	Clusterer$1.prototype.draw = function() {};
	Clusterer$1.prototype.getMap = function() {
		return null;
	};
	Clusterer$1.prototype.getPanes = function() {
		return null;
	};
	Clusterer$1.prototype.getProjection = function() {
		return {
	...
	Clusterer$1.prototype.setMap = function() {};
	Clusterer$1.prototype.addListener = function() {
		return { remove: function remove() {} };
	};
	Clusterer$1.prototype.bindTo = function() {};
	Clusterer$1.prototype.get = function() {};
	Clusterer$1.prototype.notify = function() {};
	Clusterer$1.prototype.set = function() {};
	Clusterer$1.prototype.setValues = function() {};
	Clusterer$1.prototype.unbind = function() {};
	Clusterer$1.prototype.unbindAll = function() {};
	Clusterer$1.prototype.setupStyles = function() {
	...
	Clusterer$1.prototype.fitMapToMarkers = function() {
		var markers = this.getMarkers();
	...
	Clusterer$1.prototype.getGridSize = function() {
		return this.gridSize;
	};
	Clusterer$1.prototype.setGridSize = function(gridSize) {
		this.gridSize = gridSize;
	};
	Clusterer$1.prototype.getMinimumClusterSize = function() {
		return this.minClusterSize;
	};
	Clusterer$1.prototype.setMinimumClusterSize = function(minimumClusterSize) {
		this.minClusterSize = minimumClusterSize;
	};
	Clusterer$1.prototype.getMaxZoom = function() {
		return this.maxZoom;
	};
	Clusterer$1.prototype.setMaxZoom = function(maxZoom) {
		this.maxZoom = maxZoom;
	};
	Clusterer$1.prototype.getStyles = function() {
		return this.styles;
	};
	Clusterer$1.prototype.setStyles = function(styles) {
		this.styles = styles;
	};
	Clusterer$1.prototype.getTitle = function() {
		return this.title;
	};
	Clusterer$1.prototype.setTitle = function(title) {
		this.title = title;
	};
	Clusterer$1.prototype.getZoomOnClick = function() {
		return this.zoomOnClick;
	};
	Clusterer$1.prototype.setZoomOnClick = function(zoomOnClick) {
		this.zoomOnClick = zoomOnClick;
	};
	Clusterer$1.prototype.getAverageCenter = function() {
		return this.averageCenter;
	};
	Clusterer$1.prototype.setAverageCenter = function(averageCenter) {
		this.averageCenter = averageCenter;
	};
	Clusterer$1.prototype.getIgnoreHidden = function() {
		return this.ignoreHidden;
	};
	Clusterer$1.prototype.setIgnoreHidden = function(ignoreHidden) {
		this.ignoreHidden = ignoreHidden;
	};
	Clusterer$1.prototype.getEnableRetinaIcons = function() {
		return this.enableRetinaIcons;
	};
	Clusterer$1.prototype.setEnableRetinaIcons = function(enableRetinaIcons) {
		this.enableRetinaIcons = enableRetinaIcons;
	};
	Clusterer$1.prototype.getImageExtension = function() {
		return this.imageExtension;
	};
	Clusterer$1.prototype.setImageExtension = function(imageExtension) {
		this.imageExtension = imageExtension;
	};
	Clusterer$1.prototype.getImagePath = function() {
		return this.imagePath;
	};
	Clusterer$1.prototype.setImagePath = function(imagePath) {
		this.imagePath = imagePath;
	};
	Clusterer$1.prototype.getImageSizes = function() {
		return this.imageSizes;
	};
	Clusterer$1.prototype.setImageSizes = function(imageSizes) {
		this.imageSizes = imageSizes;
	};
	Clusterer$1.prototype.getCalculator = function() {
		return this.calculator;
	};
	Clusterer$1.prototype.setCalculator = function(calculator) {
		this.calculator = calculator;
	};
	Clusterer$1.prototype.getBatchSizeIE = function() {
		return this.batchSizeIE;
	};
	Clusterer$1.prototype.setBatchSizeIE = function(batchSizeIE) {
		this.batchSizeIE = batchSizeIE;
	};
	Clusterer$1.prototype.getClusterClass = function() {
		return this.clusterClass;
	};
	Clusterer$1.prototype.setClusterClass = function(clusterClass) {
		this.clusterClass = clusterClass;
	};
	Clusterer$1.prototype.getMarkers = function() {
		return this.markers;
	};
	Clusterer$1.prototype.getTotalMarkers = function() {
		return this.markers.length;
	};
	Clusterer$1.prototype.getClusters = function() {
		return this.clusters;
	};
	Clusterer$1.prototype.getTotalClusters = function() {
		return this.clusters.length;
	};
	Clusterer$1.prototype.addMarker = function(marker, optNoDraw) {
		this.pushMarkerTo(marker);
		if (!optNoDraw) this.redraw();
	};
	Clusterer$1.prototype.addMarkers = function(markers, optNoDraw) {
	...
	Clusterer$1.prototype.pushMarkerTo = function(marker) {
		var _this = this;
	...
	Clusterer$1.prototype.removeMarker_ = function(marker) {
		var index = -1;
		if (this.markers.indexOf) index = this.markers.indexOf(marker);
		else for (var i = 0; i < this.markers.length; i++) if (marker === this.markers[i]) {
			index = i;
			break;
		}
	...
	Clusterer$1.prototype.removeMarker = function(marker, optNoDraw) {
		var removed = this.removeMarker_(marker);
		if (!optNoDraw && removed) this.repaint();
		return removed;
	};
	Clusterer$1.prototype.removeMarkers = function(markers, optNoDraw) {
		var removed = false;
	...
	Clusterer$1.prototype.clearMarkers = function() {
		this.resetViewport(true);
		this.markers = [];
	};
	Clusterer$1.prototype.repaint = function() {
		var oldClusters = this.clusters.slice();
		this.clusters = [];
		this.resetViewport(false);
		this.redraw();
		setTimeout(function timeout() {
			for (var _i = 0, oldClusters_1 = oldClusters; _i < oldClusters_1.length; _i++) oldClusters_1[_i].remove();
		}, 0);
	};
	Clusterer$1.prototype.getExtendedBounds = function(bounds) {
	...
	Clusterer$1.prototype.redraw = function() {
		this.createClusters(0);
	};
	Clusterer$1.prototype.resetViewport = function(optHide) {
		for (var _i = 0, _a = this.clusters; _i < _a.length; _i++) _a[_i].remove();
		this.clusters = [];
	...
	Clusterer$1.prototype.distanceBetweenPoints = function(p1, p2) {
		var R = 6371;
	...
	Clusterer$1.prototype.isMarkerInBounds = function(marker, bounds) {
		var position = marker.getPosition();
		if (position) return bounds.contains(position);
		return false;
	};
	Clusterer$1.prototype.addToClosestCluster = function(marker) {
		var cluster;
		var distance = 4e4;
	...
	Clusterer$1.prototype.createClusters = function(iFirst) {
		var _this = this;
		...
		if (iLast < this.markers.length) this.timerRefStatic = window.setTimeout(function() {
			...
			*/
			...
			for (var _i = 0, _a = this.clusters; _i < _a.length; _i++) _a[_i].updateIcon();
		}
	};
	Clusterer$1.prototype.extend = function(obj1, obj2) {
...
function _objectSpread$c(e) {
	for (var r = 1; r < arguments.length; r++) {
		var t = null != arguments[r] ? arguments[r] : {};
		r % 2 ? ownKeys$c(Object(t), !0).forEach(function(r$1) {
			_defineProperty(e, r$1, t[r$1]);
		}) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$c(Object(t)).forEach(function(r$1) {
			Object.defineProperty(e, r$1, Object.getOwnPropertyDescriptor(t, r$1));
		});
	}
	return e;
...
function MarkerClustererFunctional(props) {
	...
	(0, import_react.useEffect)(() => {
		if (typeof averageCenter !== "undefined" && instance !== null) updaterMap$e.averageCenter(instance, averageCenter);
	}, [instance, averageCenter]);
	(0, import_react.useEffect)(() => {
		if (typeof batchSizeIE !== "undefined" && instance !== null) updaterMap$e.batchSizeIE(instance, batchSizeIE);
	}, [instance, batchSizeIE]);
	(0, import_react.useEffect)(() => {
		if (typeof calculator !== "undefined" && instance !== null) updaterMap$e.calculator(instance, calculator);
	}, [instance, calculator]);
	(0, import_react.useEffect)(() => {
		if (typeof clusterClass !== "undefined" && instance !== null) updaterMap$e.clusterClass(instance, clusterClass);
	}, [instance, clusterClass]);
	(0, import_react.useEffect)(() => {
		if (typeof enableRetinaIcons !== "undefined" && instance !== null) updaterMap$e.enableRetinaIcons(instance, enableRetinaIcons);
	}, [instance, enableRetinaIcons]);
	(0, import_react.useEffect)(() => {
		if (typeof gridSize !== "undefined" && instance !== null) updaterMap$e.gridSize(instance, gridSize);
	}, [instance, gridSize]);
	(0, import_react.useEffect)(() => {
		if (typeof ignoreHidden !== "undefined" && instance !== null) updaterMap$e.ignoreHidden(instance, ignoreHidden);
	}, [instance, ignoreHidden]);
	(0, import_react.useEffect)(() => {
		if (typeof imageExtension !== "undefined" && instance !== null) updaterMap$e.imageExtension(instance, imageExtension);
	}, [instance, imageExtension]);
	(0, import_react.useEffect)(() => {
		if (typeof imagePath !== "undefined" && instance !== null) updaterMap$e.imagePath(instance, imagePath);
	}, [instance, imagePath]);
	(0, import_react.useEffect)(() => {
		if (typeof imageSizes !== "undefined" && instance !== null) updaterMap$e.imageSizes(instance, imageSizes);
	}, [instance, imageSizes]);
	(0, import_react.useEffect)(() => {
		if (typeof maxZoom !== "undefined" && instance !== null) updaterMap$e.maxZoom(instance, maxZoom);
	}, [instance, maxZoom]);
	(0, import_react.useEffect)(() => {
		if (typeof minimumClusterSize !== "undefined" && instance !== null) updaterMap$e.minimumClusterSize(instance, minimumClusterSize);
	}, [instance, minimumClusterSize]);
	(0, import_react.useEffect)(() => {
		if (typeof styles !== "undefined" && instance !== null) updaterMap$e.styles(instance, styles);
	}, [instance, styles]);
	(0, import_react.useEffect)(() => {
		if (typeof title !== "undefined" && instance !== null) updaterMap$e.title(instance, title);
	}, [instance, title]);
	(0, import_react.useEffect)(() => {
		if (typeof zoomOnClick !== "undefined" && instance !== null) updaterMap$e.zoomOnClick(instance, zoomOnClick);
	}, [instance, zoomOnClick]);
	(0, import_react.useEffect)(() => {
		if (!map) return;
		var clustererOptions = _objectSpread$c({}, options || defaultOptions$4);
		var clusterer = new Clusterer(map, [], clustererOptions);
		if (averageCenter) updaterMap$e.averageCenter(clusterer, averageCenter);
...
var ClustererComponent = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { markerClusterer: null });
		_defineProperty(this, "setClustererCallback", () => {
			if (this.state.markerClusterer !== null && this.props.onLoad) this.props.onLoad(this.state.markerClusterer);
		});
	}
	componentDidMount() {
		if (this.context) {
...
var InfoBox = function() {
	function InfoBox$1(options) {
		...
		this.extend(InfoBox$1, google.maps.OverlayView);
		...
		if (typeof options.visible === "undefined") if (typeof options.isHidden === "undefined") options.visible = true;
	...
	InfoBox$1.prototype.createInfoBoxDiv = function() {
		var _this = this;
		var ignoreHandler = function ignoreHandler$1(event) {
			event.returnValue = false;
			if (event.preventDefault) event.preventDefault();
			if (!_this.enableEventPropagation) cancelHandler(event);
		};
		if (!this.div) {
			this.div = document.createElement("div");
			this.setBoxStyle();
			...
			if (panes !== null) panes[this.pane].appendChild(this.div);
	...
	InfoBox$1.prototype.getCloseBoxImg = function() {
		var img = "";
		if (this.closeBoxURL !== "") {
			img = "<img alt=\"\"";
	...
	InfoBox$1.prototype.addClickHandler = function() {
		this.closeListener = this.div && this.div.firstChild && this.closeBoxURL !== "" ? google.maps.event.addListener(this.div.firstChild, "click", this.getCloseClickHandler()) : null;
	};
	InfoBox$1.prototype.closeClickHandler = function(event) {
		event.cancelBubble = true;
		if (event.stopPropagation) event.stopPropagation();
		/**
	...
	InfoBox$1.prototype.getCloseClickHandler = function() {
		return this.closeClickHandler;
	};
	InfoBox$1.prototype.panBox = function(disablePan) {
		if (this.div && !disablePan) {
			...
			if (map instanceof google.maps.Map) {
				...
				if (bounds && !bounds.contains(this.position)) map.setCenter(this.position);
	...
	InfoBox$1.prototype.setBoxStyle = function() {
		if (this.div) {
			this.div.className = this.boxClass;
			this.div.style.cssText = "";
			var boxStyle = this.boxStyle;
			for (var i in boxStyle) if (Object.prototype.hasOwnProperty.call(boxStyle, i)) this.div.style[i] = boxStyle[i];
	...
	InfoBox$1.prototype.getBoxWidths = function() {
		var bw = {
			top: 0,
			bottom: 0,
			left: 0,
	...
	InfoBox$1.prototype.onRemove = function() {
		if (this.div && this.div.parentNode) {
			this.div.parentNode.removeChild(this.div);
			this.div = null;
		}
	};
	InfoBox$1.prototype.draw = function() {
	...
	InfoBox$1.prototype.setOptions = function(options) {
		if (options === void 0) options = {};
	...
	InfoBox$1.prototype.setContent = function(content) {
	...
	InfoBox$1.prototype.setPosition = function(latLng) {
	...
	InfoBox$1.prototype.setVisible = function(isVisible) {
		this.isHidden = !isVisible;
		if (this.div) this.div.style.visibility = this.isHidden ? "hidden" : "visible";
	};
	InfoBox$1.prototype.setZIndex = function(index) {
		this.zIndex = index;
	...
	InfoBox$1.prototype.getContent = function() {
		return this.content;
	};
	InfoBox$1.prototype.getPosition = function() {
		return this.position;
	};
	InfoBox$1.prototype.getZIndex = function() {
		return this.zIndex;
	};
	InfoBox$1.prototype.getVisible = function() {
		var map = this.getMap();
		return typeof map === "undefined" || map === null ? false : !this.isHidden;
	};
	InfoBox$1.prototype.show = function() {
		this.isHidden = false;
		if (this.div) this.div.style.visibility = "visible";
	};
	InfoBox$1.prototype.hide = function() {
		this.isHidden = true;
		if (this.div) this.div.style.visibility = "hidden";
	};
	InfoBox$1.prototype.open = function(map, anchor) {
		var _this = this;
		if (anchor) {
	...
	InfoBox$1.prototype.close = function() {
		if (this.closeListener) {
			google.maps.event.removeListener(this.closeListener);
			this.closeListener = null;
		}
	...
	InfoBox$1.prototype.extend = function(obj1, obj2) {
		return function applyExtend(object) {
			for (var property in object.prototype) if (!Object.prototype.hasOwnProperty.call(this, property)) this.prototype[property] = object.prototype[property];
			return this;
		}.apply(obj1, [obj2]);
	};
	return InfoBox$1;
...
function _objectSpread$b(e) {
	for (var r = 1; r < arguments.length; r++) {
		var t = null != arguments[r] ? arguments[r] : {};
		r % 2 ? ownKeys$b(Object(t), !0).forEach(function(r$1) {
			_defineProperty(e, r$1, t[r$1]);
		}) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$b(Object(t)).forEach(function(r$1) {
			Object.defineProperty(e, r$1, Object.getOwnPropertyDescriptor(t, r$1));
		});
	}
	return e;
...
function InfoBoxFunctional(_ref) {
	...
	(0, import_react.useEffect)(() => {
		if (map) {
			...
			var positionLatLng;
			if (_position && !(_position instanceof google.maps.LatLng)) positionLatLng = new google.maps.LatLng(_position.lat, _position.lng);
			var infoBox = new InfoBox(_objectSpread$b(_objectSpread$b({}, infoBoxOptions), positionLatLng ? { position: positionLatLng } : {}));
			...
			else invariant(false, "You must provide either an anchor or a position prop for <InfoBox>.");
	...
	return containerElementRef.current ? (0, import_react_dom$1.createPortal)(import_react.Children.only(children), containerElementRef.current) : null;
}
...
var InfoBoxComponent = class extends import_react.PureComponent {
	constructor() {
		...
		_defineProperty(this, "state", { infoBox: null });
		_defineProperty(this, "open", (infoBox, anchor) => {
			if (anchor) {
				if (this.context !== null) infoBox.open(this.context, anchor);
			} else if (infoBox.getPosition()) {
				if (this.context !== null) infoBox.open(this.context);
			} else invariant(false, "You must provide either an anchor or a position prop for <InfoBox>.");
		});
		_defineProperty(this, "setInfoBoxCallback", () => {
			if (this.state.infoBox !== null && this.containerElement !== null) {
				...
				if (this.props.onLoad) this.props.onLoad(this.state.infoBox);
			}
		});
	}
	componentDidMount() {
		...
		var positionLatLng;
		if (position && !(position instanceof google.maps.LatLng)) positionLatLng = new google.maps.LatLng(position.lat, position.lng);
		var infoBox = new InfoBox(_objectSpread$b(_objectSpread$b({}, infoBoxOptions), positionLatLng ? { position: positionLatLng } : {}));
	...
	render() {
		return this.containerElement ? (0, import_react_dom$1.createPortal)(import_react.Children.only(this.props.children), this.containerElement) : null;
	}
};
...
function requireFastDeepEqual() {
	...
	fastDeepEqual = function equal$1(a, b) {
		if (a === b) return true;
		if (a && b && typeof a == "object" && typeof b == "object") {
			if (a.constructor !== b.constructor) return false;
			var length, i, keys;
...
var KDBush = class KDBush {
	...
	*/
	static from(data) {
		...
		if (version !== VERSION) throw new Error("Got v".concat(version, " data when expected v").concat(VERSION, "."));
	...
	*/
	constructor(numItems) {
		...
		if (arrayTypeIndex < 0) throw new Error("Unexpected typed array class: ".concat(ArrayType, "."));
	...
	*/
	finish() {
		...
		if (numAdded !== this.numItems) throw new Error("Added ".concat(numAdded, " items when expected ").concat(this.numItems, "."));
...
var Supercluster = class {
	...
	_appendLeaves(result, clusterId, limit, offset, skipped) {
		for (var child of this.getChildren(clusterId)) {
	...
	_cluster(tree, zoom) {
		var { radius, extent, reduce: reduce$1, minPoints } = this.options;
			...
			if (numPoints > numPointsOrigin && numPoints >= minPoints) {
				...
				for (var _neighborId of neighborIds) {
					...
					if (reduce$1) {
						...
						reduce$1(clusterProperties, this._map(data, _k));
					}
				}
				data[i + OFFSET_PARENT] = id;
				nextData.push(wx / numPoints, wy / numPoints, Infinity, id, -1, numPoints);
				if (reduce$1) nextData.push(clusterPropIndex);
			} else {
				for (var j = 0; j < stride; j++) nextData.push(data[i + j]);
				if (numPoints > 1) for (var _neighborId2 of neighborIds) {
...
function latY(lat) {
	...
	var y = .5 - .25 * Math.log((1 + sin) / (1 - sin)) / Math.PI;
...
var Cluster = class {
	...
	get bounds() {
		...
		for (var marker of this.markers) bounds.extend(MarkerUtils.getPosition(marker));
		return bounds;
	}
	get position() {
...
var GridAlgorithm = class extends AbstractViewportAlgorithm {
	...
	calculate(_ref7) {
		...
		var state = { zoom: map.getZoom() };
		var changed = false;
		if (this.state.zoom >= this.maxZoom && state.zoom >= this.maxZoom);
		else changed = !equal(this.state, state);
		this.state = state;
		if (map.getZoom() >= this.maxZoom) return {
			clusters: this.noop({ markers }),
			changed
	...
	addToClosestCluster(marker, map, projection) {
		...
		if (cluster && extendBoundsToPaddedViewport(cluster.bounds, projection, this.gridSize).contains(MarkerUtils.getPosition(marker))) cluster.push(marker);
			...
			var _cluster = new Cluster({ markers: [marker] });
...
var SuperClusterAlgorithm = class extends AbstractAlgorithm {
	...
	calculate(input) {
		var changed = false;
		var state = { zoom: input.map.getZoom() };
		...
		if (!changed) {
			if (this.state.zoom <= this.maxZoom || state.zoom <= this.maxZoom) changed = !equal(this.state, state);
		}
		this.state = state;
	...
	*/
	render(_ref14, stats, map) {
		...
		if (MarkerUtils.isAdvancedMarkerAvailable(map)) {
			var svgEl = new DOMParser().parseFromString(svg, "image/svg+xml").documentElement;
...
function extend(type1, type2) {
	...
	for (var property in type2.prototype) type1.prototype[property] = type2.prototype[property];
}
/**
* @ignore
*/
...
(function(MarkerClustererEvents$1) {
	MarkerClustererEvents$1["CLUSTERING_BEGIN"] = "clusteringbegin";
	MarkerClustererEvents$1["CLUSTERING_END"] = "clusteringend";
	MarkerClustererEvents$1["CLUSTER_CLICK"] = "click";
	...
	render() {
		...
		if (map instanceof google.maps.Map && map.getProjection()) {
			...
			if (changed || changed == void 0) {
				...
				for (var cluster of clusters) if (cluster.markers.length == 1) singleMarker.add(cluster.markers[0]);
				var groupMarkers = [];
				for (var _cluster2 of this.clusters) {
					if (_cluster2.marker == null) continue;
					if (_cluster2.markers.length == 1) {
						if (!singleMarker.has(_cluster2.marker)) MarkerUtils.setMap(_cluster2.marker, null);
					} else groupMarkers.push(_cluster2.marker);
				}
...
function _objectSpread$a(e) {
	for (var r = 1; r < arguments.length; r++) {
		var t = null != arguments[r] ? arguments[r] : {};
		r % 2 ? ownKeys$a(Object(t), !0).forEach(function(r$1) {
			_defineProperty(e, r$1, t[r$1]);
		}) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$a(Object(t)).forEach(function(r$1) {
			Object.defineProperty(e, r$1, Object.getOwnPropertyDescriptor(t, r$1));
		});
	}
	return e;
...
function useGoogleMarkerClusterer(options) {
	...
	(0, import_react.useEffect)(() => {
		if (map && markerClusterer === null) {
			var markerCluster = new MarkerClusterer(_objectSpread$a(_objectSpread$a({}, options), {}, { map }));
...
function InfoWindowFunctional(_ref) {
	...
	(0, import_react.useEffect)(() => {
		...
		else invariant(false, "You must provide either an anchor (typically render it inside a <Marker>) or a position props for <InfoWindow>.");
...
var InfoWindow = class extends import_react.PureComponent {
	constructor() {
		...
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "containerElement", null);
		_defineProperty(this, "state", { infoWindow: null });
		_defineProperty(this, "open", (infoWindow, anchor) => {
			if (anchor) infoWindow.open(this.context, anchor);
			else if (infoWindow.getPosition()) infoWindow.open(this.context);
			else invariant(false, "You must provide either an anchor (typically render it inside a <Marker>) or a position props for <InfoWindow>.");
		});
		_defineProperty(this, "setInfoWindowCallback", () => {
			if (this.state.infoWindow !== null && this.containerElement !== null) {
				...
				if (this.props.onLoad) this.props.onLoad(this.state.infoWindow);
			}
		});
	}
	componentDidMount() {
...
function PolylineFunctional(_ref) {
	...
	(0, import_react.useEffect)(() => {
		var polyline = new google.maps.Polyline(_objectSpread$9(_objectSpread$9({}, options || defaultOptions$1), {}, { map }));
...
var Polyline = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { polyline: null });
		_defineProperty(this, "setPolylineCallback", () => {
			if (this.state.polyline !== null && this.props.onLoad) this.props.onLoad(this.state.polyline);
		});
	}
	componentDidMount() {
		var polyline = new google.maps.Polyline(_objectSpread$9(_objectSpread$9({}, this.props.options), {}, { map: this.context }));
		this.registeredEvents = applyUpdatersToPropsAndRegisterEvents({
	...
	componentWillUnmount() {
		if (this.state.polyline === null) return;
...
function PolygonFunctional(_ref) {
	...
	(0, import_react.useEffect)(() => {
		var polygon = new google.maps.Polygon(_objectSpread$8(_objectSpread$8({}, options), {}, { map }));
...
var Polygon = class extends import_react.PureComponent {
	...
	componentDidMount() {
		...
		if (this.props.onLoad) this.props.onLoad(this.polygon);
	}
	componentDidUpdate(prevProps) {
		if (this.polygon) {
			unregisterEvents(this.registeredEvents);
	...
	componentWillUnmount() {
		if (this.polygon) {
			if (this.props.onUnmount) this.props.onUnmount(this.polygon);
			unregisterEvents(this.registeredEvents);
...
function RectangleFunctional(_ref) {
	...
	(0, import_react.useEffect)(() => {
		var rectangle = new google.maps.Rectangle(_objectSpread$7(_objectSpread$7({}, options), {}, { map }));
...
var Rectangle = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { rectangle: null });
		_defineProperty(this, "setRectangleCallback", () => {
			if (this.state.rectangle !== null && this.props.onLoad) this.props.onLoad(this.state.rectangle);
		});
	}
	componentDidMount() {
		var rectangle = new google.maps.Rectangle(_objectSpread$7(_objectSpread$7({}, this.props.options), {}, { map: this.context }));
		this.registeredEvents = applyUpdatersToPropsAndRegisterEvents({
...
function CircleFunctional(_ref) {
	...
	(0, import_react.useEffect)(() => {
		var circle = new google.maps.Circle(_objectSpread$6(_objectSpread$6({}, options || defaultOptions), {}, { map }));
...
var Circle = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { circle: null });
		_defineProperty(this, "setCircleCallback", () => {
			if (this.state.circle !== null && this.props.onLoad) this.props.onLoad(this.state.circle);
		});
	}
	componentDidMount() {
		var circle = new google.maps.Circle(_objectSpread$6(_objectSpread$6({}, this.props.options), {}, { map: this.context }));
		this.registeredEvents = applyUpdatersToPropsAndRegisterEvents({
...
function DataFunctional(_ref) {
	...
	(0, import_react.useEffect)(() => {
		if (map !== null) {
			var data = new google.maps.Data(_objectSpread$5(_objectSpread$5({}, options), {}, { map }));
...
var Data = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { data: null });
		_defineProperty(this, "setDataCallback", () => {
			if (this.state.data !== null && this.props.onLoad) this.props.onLoad(this.state.data);
		});
	}
	componentDidMount() {
		if (this.context !== null) {
			var data = new google.maps.Data(_objectSpread$5(_objectSpread$5({}, this.props.options), {}, { map: this.context }));
			this.registeredEvents = applyUpdatersToPropsAndRegisterEvents({
...
var KmlLayer = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { kmlLayer: null });
		_defineProperty(this, "setKmlLayerCallback", () => {
			if (this.state.kmlLayer !== null && this.props.onLoad) this.props.onLoad(this.state.kmlLayer);
		});
	}
	componentDidMount() {
		var kmlLayer = new google.maps.KmlLayer(_objectSpread$4(_objectSpread$4({}, this.props.options), {}, { map: this.context }));
		this.registeredEvents = applyUpdatersToPropsAndRegisterEvents({
...
function createOverlay(container, pane, position, bounds, getPixelPositionOffset) {
	class Overlay extends google.maps.OverlayView {
		constructor(container$1, pane$1, position$1, bounds$1) {
			super();
		...
		onAdd() {
			var _this$getPanes;
			var pane$1 = (_this$getPanes = this.getPanes()) === null || _this$getPanes === void 0 ? void 0 : _this$getPanes[this.pane];
			pane$1 === null || pane$1 === void 0 || pane$1.appendChild(this.container);
		}
		draw() {
			var projection = this.getProjection();
			...
			for (var [key, value] of Object.entries(layoutStyles)) this.container.style[key] = value;
		}
		onRemove() {
...
function convertToLatLngString(latLngLike) {
	...
	return (latLngLike instanceof google.maps.LatLng ? latLngLike : new google.maps.LatLng(latLngLike.lat, latLngLike.lng)) + "";
}
function convertToLatLngBoundsString(latLngBoundsLike) {
	if (!latLngBoundsLike) return "";
	return (latLngBoundsLike instanceof google.maps.LatLngBounds ? latLngBoundsLike : new google.maps.LatLngBounds(new google.maps.LatLng(latLngBoundsLike.south, latLngBoundsLike.east), new google.maps.LatLng(latLngBoundsLike.north, latLngBoundsLike.west))) + "";
}
...
function OverlayViewFunctional(_ref) {
	...
	return import_react_dom.createPortal(children, container);
}
...
var OverlayView = class extends import_react.PureComponent {
	constructor(props) {
		...
		_defineProperty(this, "updatePane", () => {
			...
			if (mapPanes) this.setState({ paneEl: mapPanes[mapPaneName] });
			else this.setState({ paneEl: null });
		});
	...
	render() {
		...
		if (paneEl) return import_react_dom.createPortal((0, import_jsx_runtime.jsx)("div", {
...
var updaterMap$5 = { opacity(instance, opacity) {
	instance.setOpacity(opacity);
} };
...
var GroundOverlay = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { groundOverlay: null });
		_defineProperty(this, "setGroundOverlayCallback", () => {
			if (this.state.groundOverlay !== null && this.props.onLoad) this.props.onLoad(this.state.groundOverlay);
		});
	}
	componentDidMount() {
		...
		var groundOverlay = new google.maps.GroundOverlay(this.props.url, this.props.bounds, _objectSpread$1(_objectSpread$1({}, this.props.options), {}, { map: this.context }));
		this.registeredEvents = applyUpdatersToPropsAndRegisterEvents({
...
_defineProperty(GroundOverlay, "defaultProps", { onLoad: noop });
...
function HeatmapLayerFunctional(_ref) {
	...
	var [instance, setInstance] = (0, import_react.useState)(null);
	(0, import_react.useEffect)(() => {
		if (!google.maps.visualization) invariant(!!google.maps.visualization, "Did you include prop libraries={[\"visualization\"]} in useJsApiScript? %s", google.maps.visualization);
	}, []);
	(0, import_react.useEffect)(() => {
...
var HeatmapLayer = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { heatmapLayer: null });
		_defineProperty(this, "setHeatmapLayerCallback", () => {
			if (this.state.heatmapLayer !== null && this.props.onLoad) this.props.onLoad(this.state.heatmapLayer);
		});
	}
	componentDidMount() {
...
var StreetViewPanorama = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { streetViewPanorama: null });
		_defineProperty(this, "setStreetViewPanoramaCallback", () => {
			if (this.state.streetViewPanorama !== null && this.props.onLoad) this.props.onLoad(this.state.streetViewPanorama);
		});
	}
	componentDidMount() {
...
var StreetViewService = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "state", { streetViewService: null });
		_defineProperty(this, "setStreetViewServiceCallback", () => {
			if (this.state.streetViewService !== null && this.props.onLoad) this.props.onLoad(this.state.streetViewService);
		});
	}
	componentDidMount() {
...
var DirectionsService = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "state", { directionsService: null });
		_defineProperty(this, "setDirectionsServiceCallback", () => {
			if (this.state.directionsService !== null && this.props.onLoad) this.props.onLoad(this.state.directionsService);
		});
	}
	componentDidMount() {
...
var eventMap$2 = { onDirectionsChanged: "directions_changed" };
var updaterMap$2 = {
...
var DirectionsRenderer = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "state", { directionsRenderer: null });
		_defineProperty(this, "setDirectionsRendererCallback", () => {
			if (this.state.directionsRenderer !== null) {
				this.state.directionsRenderer.setMap(this.context);
				if (this.props.onLoad) this.props.onLoad(this.state.directionsRenderer);
			}
		});
	}
	componentDidMount() {
...
var DistanceMatrixService = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty(this, "state", { distanceMatrixService: null });
		_defineProperty(this, "setDistanceMatrixServiceCallback", () => {
			if (this.state.distanceMatrixService !== null && this.props.onLoad) this.props.onLoad(this.state.distanceMatrixService);
		});
	}
	componentDidMount() {
...
var eventMap$1 = { onPlacesChanged: "places_changed" };
var updaterMap$1 = { bounds(instance, bounds) {
	instance.setBounds(bounds);
} };
var StandaloneSearchBox = class extends import_react.PureComponent {
	constructor() {
		...
		_defineProperty(this, "state", { searchBox: null });
		_defineProperty(this, "setSearchBoxCallback", () => {
			if (this.state.searchBox !== null && this.props.onLoad) this.props.onLoad(this.state.searchBox);
		});
	}
	componentDidMount() {
...
var eventMap = { onPlaceChanged: "place_changed" };
var updaterMap = {
	bounds(instance, bounds) {
		instance.setBounds(bounds);
	},
...
var Autocomplete = class extends import_react.PureComponent {
	constructor() {
		...
		_defineProperty(this, "registeredEvents", []);
		_defineProperty(this, "containerElement", (0, import_react.createRef)());
		_defineProperty(this, "state", { autocomplete: null });
		_defineProperty(this, "setAutocompleteCallback", () => {
			if (this.state.autocomplete !== null && this.props.onLoad) this.props.onLoad(this.state.autocomplete);
		});
	}
	componentDidMount() {
	...
	componentWillUnmount() {
		if (this.state.autocomplete !== null) unregisterEvents(this.registeredEvents);
	}
	render() {
		return (0, import_jsx_runtime.jsx)("div", {
			ref: this.containerElement,
...
_defineProperty(Autocomplete, "defaultProps", { className: "" });
